      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.cardLight}>
          ...
          <View style={styles.rowAlign}>
            <Text style={styles.mainValue}>1,80<Text style={styles.unitText}> L/h</Text></Text>
            <View style={styles.alertBadge}><Text style={styles.alertBadgeText}>⚠️ ZONA CRÍTICA</Text></View>
          </View>
          <Text style={styles.cardDesc}>Sua perda de líquidos excedeu a taxa de absorção recomendada para sua massa.</Text>
          {/* Mock Progress Bar */}
        ...
        <View style={styles.cardWarm}>
          <View style={styles.rowBetween}>
             ...
             <View style={styles.badgeGray}><Text style={styles.badgeGrayText}>ALERTA</Text></View>
          </View>
          <Text style={styles.mainValue}>2,40%</Text>
          <Text style={styles.cardLabel}>DÉFICIT DE MASSA (%)</Text>
          <Text style={[styles.cardDesc, {marginTop: 12}]}>Perda de massa corporal total. Acima de 2% compromete o desempenho cognitivo e motor.</Text>
        </View>
        ...
        <View style={styles.cardDarkRed}>
          ...
          <View style={styles.darkHighlightBox}>
            ...
            <Text style={styles.darkHighlightValue}>1,8<Text style={styles.darkHighlightUnit}> LITROS</Text></Text>
          </View>
        </View>
