    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <Text style={styles.pageTitle}>
          Análise de Hidratação Individualizada
        </Text>
        ...
        <View style={styles.cardLight}>
          ...
          <Text style={styles.cardDesc}>
            Sua perda de líquidos excedeu a taxa de absorção recomendada para
            sua massa.
          </Text>
        ...
        <View style={styles.cardWarm}>
          ...
          <Text style={[styles.cardDesc, { marginTop: 12 }]}>
            Perda de massa corporal total. Acima de 2% compromete o desempenho
            cognitivo e motor.
          </Text>
        </View>
        ...
        <View style={styles.cardDarkRed}>
          ...
          <Text style={styles.darkDesc}>
            Para otimizar sua recuperação pós-treino, consuma 150% do peso
            perdido nas próximas 4 horas.
          </Text>
