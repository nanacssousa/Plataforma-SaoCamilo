...
export const triagemController = {
  ...
  async getById(req: Request, res: Response): Promise<Response> {
    try {
      ...
      return res.json(await triagemService.getById(id))
    } catch (error: any) {
  ...
  async getBySessao(req: Request, res: Response): Promise<Response> {
    try {
      ...
      return res.json(await triagemService.getBySessao(id_sessao))
    } catch (error: any) {
      return res.status(404).json({ error: error.message })
    }
  },
  ...
  async getAll(req: Request, res: Response): Promise<Response> {
    try {
      return res.json(await triagemService.getAll())
    } catch (error: any) {
  ...
  async update(req: Request, res: Response): Promise<Response> {
    try {
      const id = Number(req.params.id)
      return res.json(await triagemService.update(id, req.body))
    } catch (error: any) {
      return res.status(400).json({ error: error.message })
    }
  },
