    ...
    <>
      ...
      <View style={styles.statsContainer}>
        ...
        <View style={styles.statsRow}>
          {[
            { n: "100%", d: "INSTITUIÇÕES DE ELITE" },
            { n: "98%",  d: "PRECISÃO BIOMÉTRICA"  },
            { n: "100%", d: "ALERTA DE DESIDRATAÇÃO" },
          ].map((s) => (
