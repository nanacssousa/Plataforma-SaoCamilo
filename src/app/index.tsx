...
function BottomNav({
  ...
  return (
    <BlurView
      intensity={80}
      tint="light"
      style={[styles.bottomNav, { paddingBottom: insets.bottom + 6 }]}
    >
      {items.map((item, idx) => (
        <TouchableOpacity
          key={idx}
        ...
        >
          ...
          <Ionicons
            ...
            size={24}
            color={
              active === idx ? colors.primary : `${colors.onSurfaceVariant}80`
            }
          />
          <Text
            style={[
              styles.navLabel,
              active === idx && { color: colors.primary },
            ]}
          >
            {item.label}
          </Text>
        ...
        <View style={styles.headerRow}>
          ...
          <View style={styles.headerLinks}>
            {["Performance", "Science", "Method"].map((l) => (
              <Text key={l} style={styles.headerLink}>
                {l}
              </Text>
            ))}
          </View>
      ...
      >
        ...
        >
          ...
          <View style={styles.heroContent}>
            <Animated.Text style={[styles.heroTag, tag]}>
              Protocolo Elite H2O
            </Animated.Text>
          ...
          {[
            {
              ...
              body: "Cruzamos seus dados de sono, estresse e nutricionais para gerar o plano de hidratação do dia.",
            },
            {
              id: "02",
        ...
        <View style={styles.footer}>
          ...
          <Text style={styles.footerCopy}>
            © 2024 CLINICAL ATHLETE PERFORMANCE LABS
          </Text>
          <View
            style={{
              flexDirection: "row",
